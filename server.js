...
// Student details updated to match requested picture
const studentInfo = {
    ...
    <div class="card">
      ...
      <div class="content">
        <div class="left">
          ...
          <div class="quoteWrap"><div class="quoteBox">${studentInfo.quote}</div></div>
        </div>
      </div>
    </div>
    <script>
...
// Start server with automatic port fallback if port is already in use
function start(port, maxAttempts = 10) {
